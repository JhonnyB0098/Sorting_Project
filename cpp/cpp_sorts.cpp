...
// ---------- Bubble Sort ----------
std::vector<int> cpp_bubble_sort(std::vector<int> arr) {
    int n = arr.size();
    for(int i=0; i<n-1; i++) {
...
// ---------- Insertion Sort ----------
std::vector<int> cpp_insertion_sort(std::vector<int> arr) {
    int n = arr.size();
    for(int i=1; i<n; i++) {
        int key = arr[i];
        int j = i - 1;
...
// ---------- Selection Sort ----------
std::vector<int> cpp_selection_sort(std::vector<int> arr) {
    int n = arr.size();
    for(int i=0; i<n-1; i++) {
        int min_idx = i;
        for(int j=i+1; j<n; j++) {
...
PYBIND11_MODULE(cpp_sorts, m) {
    ...
    m.def("cpp_heap_sort", &cpp_heap_sort);
    m.def("cpp_radix_sort", &cpp_radix_sort);
    m.def("cpp_bubble_sort", &cpp_bubble_sort);
    m.def("cpp_insertion_sort", &cpp_insertion_sort);
    m.def("cpp_selection_sort", &cpp_selection_sort);
}
